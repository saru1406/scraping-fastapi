...
from backend.repositories.crowdworks.crowdworks_repository import \
    CrowdWorksRepository


class StoreCrowdWorksUsecase:
    def __init__(
        self,
        crowdworks_repository: CrowdWorksRepository = Depends(CrowdWorksRepository),
    ):
